...
#select all movies directed by Christopher Nolan
print("Movies Directed by Christopher Nolen")
cursor = con.execute("SELECT m.title, m.release_year, g.name FROM movies m "
